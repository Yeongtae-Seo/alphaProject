...
<form class="w3-container" action="/master/addMovie.do"
	enctype="multipart/form-data" method="post" autocomplete="off" required>
	<div align="center">
		<div class="w3-card-4 w3-margin-bottom" align="center"
			...
			<div class="w3-container w3-margin-bottom" align="center">
				...
				<p>
					<b>관람등급</b><select class="w3-select w3-border w3-sand" name="ratingcode">
				...
				<button
						class="w3-btn w3-black" type="submit">입력</button>
