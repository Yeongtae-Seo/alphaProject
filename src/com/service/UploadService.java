...
public MovieImageVo MovieExecute(MultipartFile file, int parent) throws Exception {
		
		File dir = new File(ctx.getRealPath("/movie"),String.valueOf(parent));
		...
		MovieImageVo vo = new MovieImageVo();
		vo.setFilename(file.getOriginalFilename());
		vo.setFileurl("/movie/"+parent+"/"+file.getOriginalFilename());
		vo.setParent(parent);
		return vo;
	}
